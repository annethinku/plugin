...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 190, height: 250, top: 20, left: -85, $opacity: 0.5 },
            { '&zIndex': 2, width: 200, height: 260, top: 15, left: 134, $opacity: 0.5 },
            { '&zIndex': 3, width: 210, height: 270, top: 10, left: 0, $opacity: 0.6 },
            { '&zIndex': 4, width: 220, height: 280, top: 5, left: 110, $opacity: 0.7 },
            { '&zIndex': 5, width: 230, height: 290, top: 0, left: 262, $opacity: 1 },
            { '&zIndex': 4, width: 220, height: 280, top: 5, left: 468, $opacity: 0.7 },
            { '&zIndex': 3, width: 210, height: 270, top: 10, left: 620, $opacity: 0.6 },
            { '&zIndex': 2, width: 200, height: 260, top: 15, left: 496, $opacity: 0.5 },
            { '&zIndex': 1, width: 190, height: 250, top: 20, left: 727, $opacity: 0.5 }
        ]
